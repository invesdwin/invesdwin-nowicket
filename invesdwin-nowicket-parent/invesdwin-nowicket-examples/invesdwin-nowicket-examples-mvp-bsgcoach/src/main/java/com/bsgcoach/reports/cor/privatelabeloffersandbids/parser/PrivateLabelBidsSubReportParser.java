...
@NotThreadSafe
public class PrivateLabelBidsSubReportParser implements ISubReportParser {
    ...
    protected void parseRow(final FieldSet fieldSet, final CompanyOperatingReports reports) {
        final PrivateLabelBidsSubReportParserRow row = PrivateLabelBidsSubReportParserRow.valueOfTitle(curCategory1,
