...
@NotThreadSafe
public class PrivateLabelPairsOfferedSubReportParser implements ISubReportParser {
    ...
    protected void parseRow(final FieldSet fieldSet, final CompanyOperatingReports reports) {
        final PrivateLabelPairsOfferedSubReportParserRow row = PrivateLabelPairsOfferedSubReportParserRow.valueOfTitle(curTitle2);
