...
@NotThreadSafe
public class IncomeStatementSubReportParser implements ISubReportParser {
    ...
    protected void parseRow(final FieldSet fieldSet, final CompanyOperatingReports reports) {
        final IncomeStatementSubReportParserRow row = IncomeStatementSubReportParserRow.valueOfTitle(curCategory1,
                curCategory2, curTitle1, curTitle2);
        final IncomeStatement report = reports.getIncomeStatement();
