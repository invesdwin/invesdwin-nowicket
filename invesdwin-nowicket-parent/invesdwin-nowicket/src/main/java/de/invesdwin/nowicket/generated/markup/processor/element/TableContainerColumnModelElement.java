...
@NotThreadSafe
public class TableContainerColumnModelElement extends ATableColumnModelElement<TableContainerColumnBeanPathElement> {

    public TableContainerColumnModelElement(final AModelContext context,
            final TableContainerColumnBeanPathElement beanPathElement) {
