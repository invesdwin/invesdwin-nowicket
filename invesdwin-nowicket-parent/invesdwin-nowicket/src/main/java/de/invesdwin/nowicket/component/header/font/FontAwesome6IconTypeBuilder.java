 ...
 * <b>Examples :</b>
 * <ul>
 * <li>To rotate an icon 90° :
 * <code>    FontAwesome6IconTypeBuilder.on(FontAwesome6Graphic.key).rotate(Rotation.rotate_90).build()</code></li>
 * <li>To spin an icon : <code>    FontAwesome6IconTypeBuilder.on(FontAwesome6Graphic.key).spin().build()</code></li>
...
public class FontAwesome6IconTypeBuilder {
    ...
    /**
     * @param fontAwesomeGraphic
     *            icon to use in the builder
