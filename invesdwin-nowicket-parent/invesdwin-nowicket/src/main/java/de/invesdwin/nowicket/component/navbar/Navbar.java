...
import de.agilecoders.wicket.core.markup.html.bootstrap.navbar.Navbar.CollapseBreakpoint;
...
/**
 * A {@link Navbar} is a navigation component that holds a list of elements, mostly Links/MenuButtons/Dropdowns.
 * <p/>
 *
 * <pre>
...
public class Navbar extends Panel implements Invertible<Navbar> {
     ...
     *            to filter
     * @param withPosition
     *            position a component must have
     * @return new model
     */
    private IModel<List<Component>> newPositionDependedComponentModel(final List<INavbarComponent> components,
        ...
        return new LoadableDetachableModel<List<Component>>() {
            ...
            public List<Component> load() {
                return Generics2.transform(Generics2.filter(components, withPosition),
                        NAVBAR_COMPONENT_TO_COMPONENT_FUNCTION);
            }
        };
    }
    ...
    /**
     * @return the page class which is used for the brand name link. The application's homepage is used by default.
     */
    ...
    /**
     * creates a new transparent container which is used to append the "data-bs-target" attribute to the collapse
     * button.
     *
     * @param componentId
     *            The non-null id of collapse button
     * @param selector
     *            non-null jquery selector to collapse
    ...
    public Navbar setBrandName(final IModel<String> brandName) {
        final Component name = getBrandNameLink().get("brandLabel");
    ...
    public Navbar setBrandImage(final ResourceReference imageResourceReference,
        ...
        final Image brandImage = (Image) getBrandNameLink().get("brandImage");
     ...
     *
     * @param invert
     *            whether to invert the color or not
     * @return the component's current instance
     */
    @Override
     ...
     *
     * @param breakpoint
     *            the breakpoint for collapsing navigation bar
     * @return the component's current instance
     */
    ...
    /**
     * A {@link Predicate} that filters out all {@link INavbarComponent}s that don't match the given
    ...
    private static final class PositionFilter implements Predicate<INavbarComponent>, IClusterable {
         ...
         *
         * @param position
         *            which filtered component must match
         */
    ...
    private static final class NavbarComponentToComponentFunction
         ...
         *
         * @param markupId
         *            The markup id to use for each new component
         */
