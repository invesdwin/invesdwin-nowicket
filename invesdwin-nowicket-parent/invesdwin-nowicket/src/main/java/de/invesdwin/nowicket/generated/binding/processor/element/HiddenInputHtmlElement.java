...
@NotThreadSafe
public class HiddenInputHtmlElement extends AModelHtmlElement<AModelElement<? extends APropertyBeanPathElement>, Object>
        implements ITextInputHtmlElement<Object> {

    public static final String INPUT_TYPE_HIDDEN = Input.hidden;

    public HiddenInputHtmlElement(final HtmlContext context, final Element element) {
        super(context, element);
    }

    @Override
    protected void innerAccept(final IHtmlVisitor visitor) {
        visitor.visitHiddenInput(this);
    }
