/*
PNotify 3.2.1 sciactive.com/pnotify/
...
var init = function(root){
  ...
  $.extend(PNotify.prototype, {
    ...
    options: {
      ...
      text_escape: false,
      // What styling classes to use. (Can be either "brighttheme", "bootstrap4".)
      styling: "bootstrap4",
  ...
  $.extend(PNotify, {
    ...
    styling: {
      ...
      bootstrap4: {
        ...
        notice_icon: "fa-solid fa-circle-exclamation",
        info: "alert-info",
        info_icon: "fa-solid fa-circle-info",
        success: "alert-success",
        success_icon: "fa-solid fa-check",
        error: "alert-danger",
