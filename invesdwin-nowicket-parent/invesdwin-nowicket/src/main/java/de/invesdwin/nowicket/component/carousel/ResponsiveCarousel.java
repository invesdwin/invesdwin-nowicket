...
/**
 * Remove as soon as https://github.com/l0rdn1kk0n/wicket-bootstrap/issues/959 is released.
 */
@NotThreadSafe
public class ResponsiveCarousel extends Panel {

    private static final long serialVersionUID = 1L;
    private java.time.Duration interval = java.time.Duration.ofSeconds(5L);
     ...
     */
    protected Component newImageList(final String wicketId) {
     ...
     */
    public final ResponsiveCarousel setInterval(final java.time.Duration interval) {
