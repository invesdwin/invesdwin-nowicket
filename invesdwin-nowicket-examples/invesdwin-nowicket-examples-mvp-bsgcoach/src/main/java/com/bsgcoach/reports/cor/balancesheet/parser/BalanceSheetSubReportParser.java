...
@NotThreadSafe
public class BalanceSheetSubReportParser implements ISubReportParser {
    ...
    protected void parseRow(final FieldSet fieldSet, final CompanyOperatingReports reports) {
        final BalanceSheetSubReportParserRow row = BalanceSheetSubReportParserRow.valueOfTitle(curCategory1,
