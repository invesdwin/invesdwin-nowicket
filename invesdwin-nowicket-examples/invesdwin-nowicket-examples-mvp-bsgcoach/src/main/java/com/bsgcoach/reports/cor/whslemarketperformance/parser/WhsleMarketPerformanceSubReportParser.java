package com.bsgcoach.reports.cor.whslemarketperformance.parser;
...
import com.bsgcoach.reports.cor.internetmarketperformance.parser.InternetAndWhsleMarketPerformanceSubReportParserRow;
...
@NotThreadSafe
public class WhsleMarketPerformanceSubReportParser implements ISubReportParser {
    ...
    protected void parseRow(final FieldSet fieldSet, final CompanyOperatingReports reports) {
        final InternetAndWhsleMarketPerformanceSubReportParserRow row = InternetAndWhsleMarketPerformanceSubReportParserRow.valueOfTitle(
                curTitle1, curTitle2);
        final WhsleMarketPerformance report = reports.getWhsleMarketPerformance(curRegion);
